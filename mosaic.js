(function () {
    var l = ".filtered",
        p = ".item",
        q = ".item.open",
        r = "Failed to parse post content",
        t = "animating",
        u = "body",
        v = "object",
        w = "string",
...
*/
    ...
    function F(a, b) {
        a.classList ? (b = a.classList.contains(b)) : ((a = a.classList ? a.classList : D(a).match(/\S+/g) || []), (b = 0 <= ea(a, b)));
        return b;
    }
    function G(a, b) {
            ...
            : F(a, b) &&
              E(
                  ...
                  Array.prototype.filter
                      .call(a.classList ? a.classList : D(a).match(/\S+/g) || [], function (c) {
                          return c != b;
                      })
                      .join(" ")
              );
    ...
    var J = blogger.core.inherit(blogger.core.view);
    J.prototype.modules = [blogger.modules.ViewLightbox];
    function fa(a) {
        ...
        Array.from(b.children).forEach(function (c) {
            c.matches(".singleton-element, #injected-iframe") || c.remove();
        });
        $(u).append(a.template("Main"));
        I(b, "instant", 1 == a.ui.settings.headless);
        a.ui.notify("updated");
    }
    function ha(a) {
        ...
        c.setAttribute("id", "css");
        c.append(a.template("CSS"));
        b.append(c);
    }
    J.prototype.log = function (a) {
    ...
    var ia = -1 != K().toLowerCase().indexOf("webkit") && -1 == K().indexOf("Edge");
    function L(a, b) {
        this.width = a;
        this.height = b;
    }
    ...
    function R(a, b) {
        if (b.height && !(0 >= b.height)) {
            for (; a.rows.length < b.i + b.height; ) {
                for (var c = a.rows, d = c.push, e = a, f = [], h = 0; h < e.o; h++) f.push(null);
                d.call(c, f);
            }
    ...
    ja.prototype.remove = function (a) {
        a = this.j[a];
        for (var b = 0; b < a.height; b++) for (var c = this.rows[a.i + b], d = 0; d < a.width; d++) c[a.column + d] = null;
    };
    function S(a) {
    ...
    function ma(a) {
        for (var b = !1, c = 0; c < a.rows.length; c++)
            for (var d = 0; d < a.o; d++) {
                a: {
                    var e = a;
                    for (var f = c, h = d, g = null, k = null != f ? f : 0; k < e.rows.length; k++) {
                        for (var m = g ? g.right + 1 : e.o, n = g ? g.left : 0; n < m; n++)
                            if (!Q(e, k, n))
                                if (g) g.i == k && (g.width++, g.right++);
                                else {
                                    if (!f || f != k || (null != h && h != n)) g = { i: k, top: k, bottom: k, column: n, left: n, right: n, width: 1, height: 1 };
                                }
                            else if (g) {
                                e = g;
                                break a;
                            }
                        g && g.i != k && (g.height++, g.bottom++);
                    }
                    e = g;
                }
                if (e) {
                    ...
                    for (h = e.column; h < a.o; h++) {
                        ...
                        if (g && ((k = g.position()), k.left >= e.left && k.right <= e.right)) {
                            f = g;
                            break;
                        }
                    }
                    f && ((f = !1), g && 0 < g.id && ((f = a.j[g.id - 1].position()), (f = f.top == e.top ? e.right < f.left : f.top > e.top)), f || (a.remove(g.id), (g.i = e.i), R(a, g), (b = !0)));
                }
            }
        return b;
    }
    function na(a, b, c) {
        ...
        if (b.height != c || b.width != a.o) {
            ...
            e < b.i && (e = b.i);
            f = c - b.height;
            for (var h = b.position(), g = h.top; g <= h.bottom; g++)
                for (var k = 0; k < a.o; k++) {
                    var m = a.j[a.rows[g][k]];
    ...
    oa.prototype.position = function () {
    ...
    blogger.core.inherit(T, J);
    blogger.ui().registerView(T);
    x = T.prototype;
    x.defaults = { name: "mosaic", size: 160, imgSize: 320, minColumns: 2, maxColumns: 20, maxWidth: 2, maxHeight: 2, margin: 0, spacing: 5, scrollTimer: 700, animateTimer: 700, measureInterval: 1e3, autoCollapse: !0, pageSize: 10 };
    x.scope = function (a) {
        a.scope("size:thumbnail", this.settings.size * Math.max(this.settings.maxWidth, this.settings.maxHeight));
    };
    x.onInitComplete = function () {
    ...
    //modif
    //x.onResize=function(){clearTimeout(this.H);F(document.querySelector(u),t)||(this.H=setTimeout(this.I.bind(this),500))};

    x.onRender = function (a) {
        var b = this;
        if (a) {
            var c = [],
                d = 0,
            ...
            a.forEach(function (h) {
                var g = qa(b),
                    k = $(b.template("Item", h))[0],
                    m = U(b, g);
                k.dataset.id = h.id;
                k.dataset.D = g.id;
                O(k, m.width, m.height);
                M(k, m.left, m.top);
    ...
    function X(a) {
        for (
            var b = Array.from(document.querySelectorAll(p)).filter(function (g) {
                    return !g.matches(l);
                }),
            ...
            var h = b[e];
            f = U(a, f);
            O(h, f.width, f.height);
            M(h, f.left, f.top);
            d = Math.max(d, f.top + f.height + 2 * c);
        }
        b = a.m.v;
    ...
    x.F = function () {
        if (!F(document.querySelector(u), t)) {
            var a = document.querySelector(q);
            if (a) {
                var b = Y(this, a);
                if (null != b) {
                    ...
                    this.u.j[b].height != a && (na(this.u, b, a), Z(this), X(this));
                }
            }
        }
    };
    function V(a) {
        ...
        document.querySelectorAll(q).forEach(function (b) {
            ...
            if (d.height != e || d.width != b.width) {
                ...
                for (var f = -1, h = 0; h < d.id; h++) f = Math.max(b.j[h].position().bottom + 1, f);
                f < d.i && (f = d.i);
                h = e - d.height;
                for (var g = d.position(), k = g.top; k <= g.bottom; k++)
                    for (var m = 0; m < b.o; m++) {
                        var n = b.j[b.rows[k][m]];
                        n && n.id > d.id && (h = Math.max(h, e - (n.i - d.i)));
                    }
                h += f - d.i;
                d.i = f;
                d.width = c;
                d.height = e;
                for (c = d.id + 1; c < b.j.length; c++) b.j[c].i += h;
                ka(b);
            }
        });
        Z(a);
    ...
    function ua(a, b) {
        ...
        if (d) {
            var e = va(a, d) + 5;
            na(a.u, c, Math.ceil(e / (a.settings.spacing + a.m.size)));
            Z(a);
            c = ra(a, d);
            G(b, "open");
    ...
    function Z(a) {
        G(document.querySelector(u), t);
        clearTimeout(a.C);
        a.C = setTimeout(function () {
            H(document.querySelector(u), t);
        }, a.settings.animateTimer);
    }
    x.onSelect = function (a) {
        a = document.querySelector('.item[data-id="' + a.id + '"]');
        var b = !F(a, "open");
        this.settings.autoCollapse && V(this);
        b ? (ua(this, a), X(this), wa(this, a)) : this.ui.clearSelection();
    };
    x.onClearSelection = function () {
        var a = document.querySelector(q);
        V(this);
        W(this);
        wa(this, a);
    ...
    function qa(a) {
        ...
        if (c == b.rows.length) c = { i: c, column: 0, width: b.o };
            ...
            for (var e = -1, f = 0, h = 0; h < d.length; h++)
                if (!Q(b, c, h)) 0 > e && (e = h), f++;
                else if (0 <= e) break;
            c = 0 <= e ? { i: c, column: e, width: f } : void 0;
        }
        a = new oa(Math.min(Math.floor(Math.random() * a.settings.maxWidth) + 1, c.width), Math.floor(Math.random() * a.settings.maxHeight) + 1, c.i, c.column);
        R(b, a);
        return a;
    }
    function ta(a) {
    ...
    function va(a, b) {
        ...
        G(d, "virtualBrick");
        c.append(d);
        document.querySelector(u).append(c);
        var e = a.m.v;
        ...
        b: {
            C(b, "Node cannot be null or undefined.");
    ...
    x.onFilter = function (a) {
        ...
        document.querySelectorAll(p).forEach(function (c) {
            I(c, "filtered", !b.includes(c.dataset.id));
        });
        W(this);
        $("html,body").stop().animate({ scrollTop: 0 });
    };
    x.onClearFilter = function () {
        V(this);
    ...
    x.onItemClick = function (a) {
        var b = a.target.closest(p),
            c = b.dataset.id;
        if ((!F(b, "open") || a.target.matches(".item, .article")) && c && !a.metaKey) return a.stopPropagation(), a.preventDefault(), this.ui.select(c, $(b)), !1;
    };
}.call(this));
